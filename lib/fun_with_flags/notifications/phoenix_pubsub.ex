  ...
  defmodule FunWithFlags.Notifications.PhoenixPubSub do
    ...
    defp subscribe(attempt) when attempt <= @max_attempts do
      try do
        ...
        e ->
          # The pubsub process was probably not running. This happens when using it in Phoenix, as it tries to connect
          # the first time while the application is booting, and the Phoenix.PubSub process is not fully started yet.
          Logger.debug(fn ->
