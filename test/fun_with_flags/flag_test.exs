defmodule FunWithFlags.FlagTest do
  ...
  describe "enabled?(flag, for: item)" do
    ...
    test "when the checked item belongs to multiple conflicting group gates, DISABLED gates take precendence",
         %{john: john, arya: arya} do
      flag = %Flag{
        name: :pear,
        gates: [
    ...
    test "an actor gate takes precedence over the boolean gate, when enabling", %{
      john: john,
      arya: arya
    } do
    ...
    test "an actor gate takes precedence over the boolean gate, when disabling", %{
      john: john,
      arya: arya
    } do
    ...
    @tag :flaky
    test "an actor gate takes precedence over the percentage_of_time gate, when enabling", %{
      john: john,
      arya: arya
    } do
    ...
    @tag :flaky
    test "an actor gate takes precedence over the percentage_of_time gate, when disabling", %{
      john: john,
      arya: arya
    } do
    ...
    test "an actor gate takes precedence over the percentage_of_actors gate, when enabling", %{
      john: john,
      arya: arya
    } do
      # disabled for both
    ...
    test "an actor gate takes precedence over the percentage_of_actors gate, when disabling", %{
      john: john,
      arya: arya
    } do
      # enabled for both
    ...
    test "a group gate takes precedence over the boolean gate, when enabling", %{
      john: john,
      arya: arya
    } do
      flag = %Flag{
    ...
    test "a group gate takes precedence over the boolean gate, when disabling", %{
      john: john,
      arya: arya
    } do
      flag = %Flag{
    ...
    @tag :flaky
    test "a group gate takes precedence over the percentage_of_time gate, when enabling", %{
      john: john,
      arya: arya
    } do
      mostly_disabled = Gate.new(:percentage_of_time, 0.000000001)
    ...
    @tag :flaky
    test "a group gate takes precedence over the percentage_of_time gate, when disabling", %{
      john: john,
      arya: arya
    } do
      mostly_enabled = Gate.new(:percentage_of_time, 0.999999999)
    ...
    test "a group gate takes precedence over the percentage_of_actors gate, when enabling", %{
      john: john,
      arya: arya
    } do
      # disabled for both
    ...
    test "a group gate takes precedence over the percentage_of_actors gate, when disabling", %{
      john: john,
      arya: arya
    } do
      # enabled for both
    ...
    test "an actor gate takes precedence over a group gate, when enabling", %{
      john: john,
      arya: arya
    } do
      flag = %Flag{
    ...
    test "an actor gate takes precedence over a group gate, when disabling", %{
      john: john,
      arya: arya
    } do
      flag = %Flag{
    ...
    @tag :flaky
    test "a boolean gate takes precedence over the percentage_of_time gate, when enabling", %{
      john: john,
      arya: arya
    } do
      mostly_disabled = Gate.new(:percentage_of_time, 0.000000001)
    ...
    @tag :flaky
    test "a boolean gate does NOT take precedence over the percentage_of_time gate, when disabling",
         %{john: john, arya: arya} do
      mostly_enabled = Gate.new(:percentage_of_time, 0.999999999)
    ...
    test "a boolean gate takes precedence over the percentage_of_actors gate, when enabling", %{
      john: john,
      arya: arya
    } do
      # disabled for both
    ...
    test "a boolean gate does NOT take precedence over the percentage_of_actors gate, when disabling",
         %{john: john, arya: arya} do
      # enabled for both
      gate = Gate.new(:percentage_of_actors, 0.8)
